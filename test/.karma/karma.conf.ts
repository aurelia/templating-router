    ...
    webpack: {
      ...
      resolve: {
        ...
        alias: {
          ...
          /**
           * Following are alias to make webpack bundle those files
           */
      ...
      module: {
        rules: [
          { test: /\.ts$/, loader: 'ts-loader', exclude: /node_modules/, options: { configFile: path.resolve(BASE_DIR, 'test/tsconfig.json') } },
          { test: /\.html$/, loader: 'html-loader', options: { attrs: false } }
        ]
      },
      plugins: [
        new AureliaPlugin({
